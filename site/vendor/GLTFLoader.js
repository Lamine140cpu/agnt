/* GLTFLoader de three.js r185, vendorisé.
   Seule modification : l'import « three » pointe sur la copie locale — il n'y a
   pas de résolution de modules par nom dans une page servie telle quelle. */
import {
	AnimationClip,
	Bone,
	Box3,
